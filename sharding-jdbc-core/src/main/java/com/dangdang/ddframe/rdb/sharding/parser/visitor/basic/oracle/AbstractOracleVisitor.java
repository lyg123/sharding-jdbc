 ...
 * @author liyiguang
 */
public abstract class AbstractOracleVisitor extends OracleOutputVisitor implements SQLVisitor {
    ...
    @Override
    public final boolean visit(final OracleSelectTableReference x) {
