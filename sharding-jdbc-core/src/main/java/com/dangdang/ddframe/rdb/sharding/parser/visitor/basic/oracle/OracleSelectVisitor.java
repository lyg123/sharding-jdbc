...
public class OracleSelectVisitor extends AbstractOracleVisitor {
    ...
    public boolean visit(final OracleOrderBy x) {
    ...
    public boolean visit(final SQLSelectGroupByClause x) {
    	List<SQLExpr> sqlExprs = x.getItems();
    	OrderByType orderByType = OrderByType.ASC ;// 固定ASC
...
//    }
    ...
    @Override
    public void endVisit(final OracleSelect x) {
